...
import org.eclipse.milo.opcua.sdk.server.identity.OAuthIssuedTokenValidator;
...
public class OAuthServerStandalone {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OAuthServerStandalone.class);

    private final OpcUaServer server;

    public static void main(String[] args) {
        OAuthServerStandalone server = new OAuthServerStandalone();
    ...
    private OAuthServerStandalone() {
        ...
        IdentityValidator oAuthIssuedTokenValidator = new OAuthIssuedTokenValidator();

        UserTokenPolicy oauthTokenPolicy = new UserTokenPolicy(
                "oauth2",
        ...
        OpcUaServerConfig serverConfig = OpcUaServerConfig.builder()
            ...
            .setIdentityValidator(oAuthIssuedTokenValidator)
